...
requirements specified in the latest STIX 2 specifications. In addition to
...
cases of conflict with the STIX specification, the specification
takes precedence.

The STIX 2 specification contains two types of requirements:
